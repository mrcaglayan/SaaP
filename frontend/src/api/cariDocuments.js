...
export async function listCariDocumentMentionCandidates(documentId, params = {}) {
  return run(() =>
    api.get(`/api/v1/cari/documents/${documentId}/comments/mention-candidates${toCariQueryString(params)}`)
  );
}
