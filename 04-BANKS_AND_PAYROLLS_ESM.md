...
Autogenerated companion document with CommonJS code snippets converted to ESM style.
Source: `04-BANKS_AND_PAYROLLS.md` (renumbered roadmap primary).
# Migration Renumbering Map

This file is a collision-free renumbered variant of `04-BANKS_AND_PAYROLLS.md`.
...
---
# 04-BANKS_AND_PAYROLLS

Consolidated roadmap document built from:
1. 04-PR_STPES_BANK_ADOPTION_BASELINE.md
2. 04-PR_STPES_BANK.md
3. 05-PR_STEPS_PAYROLS.md
4. 06-PR-BANK AND PAYROLLS FOLLOUPS.md

Generated on: 2026-02-26

---

## Source: 04-PR_STPES_BANK_ADOPTION_BASELINE.md
...
## Source: 04-PR_STPES_BANK.md

# Bank PR Steps (Original Draft)

> Implementation note (mandatory): do not execute this file directly in this repository.
> First align every Bank PR with `04-BANKS_AND_PAYROLLS.md`, then implement from the adopted mapping there.
...
## Source: 06-PR-BANK AND PAYROLLS FOLLOUPS.md
