...
import payrollOwnershipRoutes from "./routes/payroll.ownership.routes.js";
...
import inventoryLandedCostRoutes from "./routes/inventory.landed-cost.routes.js";
...
app.use("/api/v1/payroll", requireAuth, payrollOwnershipRoutes);
...
app.use("/api/v1/inventory", requireAuth, inventoryLandedCostRoutes);
