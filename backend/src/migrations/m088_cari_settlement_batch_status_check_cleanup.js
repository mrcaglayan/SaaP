...
const migration088CariSettlementBatchStatusCheckCleanup = {
  key: "m088_cari_settlement_batch_status_check_cleanup",
  description:
    "Drop legacy strict settlement status check and ensure cash-linked-aware status guard remains active",
  async up(connection) {
...
export default migration088CariSettlementBatchStatusCheckCleanup;
