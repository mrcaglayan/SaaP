...
const migration089CariSettlementBatchStatusCheckFinalCleanup = {
  key: "m089_cari_settlement_batch_status_check_final_cleanup",
  description:
    "Final cleanup of legacy strict settlement status checks after cash-linked status guard rollout",
  async up(connection) {
...
export default migration089CariSettlementBatchStatusCheckFinalCleanup;
