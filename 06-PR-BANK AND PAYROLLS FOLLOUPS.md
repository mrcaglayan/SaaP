...
- `backend/src/migrations/m029_payroll_corrections_reversals.js`
...
## 1) Migration — `backend/src/migrations/m029_payroll_corrections_reversals.js`

```js
// backend/src/migrations/m029_payroll_corrections_reversals.js

module.exports = {
  id: "m029_payroll_corrections_reversals",
...
const {
  ...
  validateReverseRunBody,
  validateCreateCorrectionShellBody,
} = require("./payroll.corrections.validators");
const service = require("../services/payroll.corrections.service");
...
```js
// backend/src/index.js
const payrollCorrectionsRoutes = require("./routes/payroll.corrections");
...
```js
// backend/src/migrations/index.js
const m029_payroll_corrections_reversals = require("./m029_payroll_corrections_reversals");

module.exports = [
  // ...
  m029_payroll_corrections_reversals,
];
```
...
- `backend/src/migrations/m030_payroll_partial_settlement_and_manual_override.js`
...
## 1) Migration — `backend/src/migrations/m030_payroll_partial_settlement_and_manual_override.js`

```js
// backend/src/migrations/m030_payroll_partial_settlement_and_manual_override.js

module.exports = {
  id: "m030_payroll_partial_settlement_and_manual_override",
...
const {
  ...
  validateApproveApplyOverrideBody,
  validateRejectOverrideBody,
} = require("./payroll.settlementOverrides.validators");
const service = require("../services/payroll.settlementOverrides.service");
...
```js
// backend/src/index.js
const payrollSettlementOverridesRoutes = require("./routes/payroll.settlementOverrides");
...
```js
// backend/src/migrations/index.js
const m030_payroll_partial_settlement_and_manual_override = require("./m030_payroll_partial_settlement_and_manual_override");

module.exports = [
  // ...
  m030_payroll_partial_settlement_and_manual_override,
];
```
...
- `backend/src/migrations/m031_bank_connectivity_adapters.js`
...
## 1) Migration — `backend/src/migrations/m031_bank_connectivity_adapters.js`

```js id="1qj5be"
// backend/src/migrations/m031_bank_connectivity_adapters.js

module.exports = {
  id: "m031_bank_connectivity_adapters",
...
const mockOpenBankingAdapter = require("./mockOpenBanking.adapter");
...
const { getBankConnectorAdapter } = require("./bankConnectorAdapters");
...
function getB02ImportFn() {
  ...
  const svc = require("./bankStatementImports.service");
...
const {
  ...
  validateAccountLinkBody,
  validateSyncTriggerBody,
} = require("./bank.connectors.validators");
const service = require("../services/bank.connectors.service");
...
```js id="0iunwx"
// backend/src/index.js
const bankConnectorRoutes = require("./routes/bank.connectors");
...
```js id="jlwm2j"
// backend/src/migrations/index.js
const m031_bank_connectivity_adapters = require("./m031_bank_connectivity_adapters");

module.exports = [
  // ...
  m031_bank_connectivity_adapters,
];
```
...
async function main() {
  ...
  const {
    syncDueBankConnectors,
  } = require("../src/services/bank.connectors.service");
...
- `backend/src/migrations/m032_bank_payment_exports_and_acks.js`
...
## 1) Migration — `backend/src/migrations/m032_bank_payment_exports_and_acks.js`

```js
// backend/src/migrations/m032_bank_payment_exports_and_acks.js

module.exports = {
  id: "m032_bank_payment_exports_and_acks",
...
const genericCsvV1 = require("./genericCsvV1.format");
...
const { getBankPaymentFileFormat } = require("./bankPaymentFileFormats");
...
const {
  ...
  validateExportBatchBody,
  validateImportAckBody,
} = require("./bank.paymentFiles.validators");
const service = require("../services/bank.paymentFiles.service");
...
```js
// backend/src/index.js
const bankPaymentFilesRoutes = require("./routes/bank.paymentFiles");
...
```js
// backend/src/migrations/index.js
const m032_bank_payment_exports_and_acks = require("./m032_bank_payment_exports_and_acks");

module.exports = [
  // ...
  m032_bank_payment_exports_and_acks,
];
```
...
- `backend/src/migrations/m033_bank_reconciliation_rules_and_exceptions.js`
...
## 1) Migration — `backend/src/migrations/m033_bank_reconciliation_rules_and_exceptions.js`

```js id="j4c9pw"
// backend/src/migrations/m033_bank_reconciliation_rules_and_exceptions.js

module.exports = {
  id: "m033_bank_reconciliation_rules_and_exceptions",
...
const {
  writeExceptionEvent,
} = require("./bank.reconciliationExceptions.service");

// IMPORTANT: patch B03 to export this helper (see patch section below)
function getB03ReconcileHelper() {
  const svc = require("./bank.reconciliation.service"); // adapt to your B03 service path
...
const express = require("express");
const rulesService = require("../services/bank.reconciliationRules.service");
const engineService = require("../services/bank.reconciliationEngine.service");
const {
  validateRuleIdParam,
  validateCreateRuleBody,
  validateUpdateRuleBody,
  validateAutoPreviewBody,
  validateAutoApplyBody,
} = require("./bank.reconciliationRules.validators");
...
const express = require("express");
const exService = require("../services/bank.reconciliationExceptions.service");
const engineService = require("../services/bank.reconciliationEngine.service");
const {
  validateExceptionIdParam,
  validateListExceptionsQuery,
  ...
  validateResolveBody,
  validateIgnoreBody,
} = require("./bank.reconciliationExceptions.validators");
...
```js id="uu8rkr"
// backend/src/index.js
const bankReconciliationRulesRoutes = require("./routes/bank.reconciliationRules");
const bankReconciliationExceptionsRoutes = require("./routes/bank.reconciliationExceptions");
...
```js id="mqc1jn"
// backend/src/migrations/index.js
const m033_bank_reconciliation_rules_and_exceptions = require("./m033_bank_reconciliation_rules_and_exceptions");

module.exports = [
  // ...
  m033_bank_reconciliation_rules_and_exceptions,
];
```
...
- `backend/src/migrations/m034_bank_recon_autopost_templates.js`
...
## 1) Migration — `backend/src/migrations/m034_bank_recon_autopost_templates.js`

```js id="b08m34"
// backend/src/migrations/m034_bank_recon_autopost_templates.js

module.exports = {
  id: "m034_bank_recon_autopost_templates",
...
function getGlCreateAndPostHelper() {
  const svc = require("./gl.journals.service");
...
const express = require("express");
const svc = require("../services/bank.reconciliationPostingTemplates.service");
const autoPostSvc = require("../services/bank.reconciliationAutoPosting.service");
const {
  validateTemplateIdParam,
  validateCreateTemplateBody,
  validateUpdateTemplateBody,
} = require("./bank.reconciliationPostingTemplates.validators");
...
function getB03ReconcileGlHelper() {
  const svc = require("./bank.reconciliation.service");
...
function getB08AutoPostService() {
  return require("./bank.reconciliationAutoPosting.service");
}
```
...
```js id="b08idx"
// backend/src/index.js
const bankReconciliationPostingTemplatesRoutes = require("./routes/bank.reconciliationPostingTemplates");
...
```js id="b08migidx"
// backend/src/migrations/index.js
const m034_bank_recon_autopost_templates = require("./m034_bank_recon_autopost_templates");

module.exports = [
  // ...
  m034_bank_recon_autopost_templates,
];
```
...
- `backend/src/migrations/m035_bank_returns_and_recon_differences.js`
...
## 1) Migration — `backend/src/migrations/m035_bank_returns_and_recon_differences.js`

```js id="b08bm35"
// backend/src/migrations/m035_bank_returns_and_recon_differences.js

module.exports = {
  id: "m035_bank_returns_and_recon_differences",
...
const express = require("express");
const svc = require("../services/bank.paymentReturns.service");
const {
  validateReturnEventIdParam,
  validateListReturnEventsQuery,
  validateCreateManualReturnBody,
  validateIgnoreReturnEventBody,
} = require("./bank.paymentReturns.validators");
...
const express = require("express");
const svc = require("../services/bank.reconciliationDifferenceProfiles.service");
const {
  validateProfileIdParam,
  validateCreateDifferenceProfileBody,
  validateUpdateDifferenceProfileBody,
} = require("./bank.reconciliationDifferenceProfiles.validators");
...
function getPaymentReturnsService() {
  return require("./bank.paymentReturns.service");
}

function getReconciliationDifferencesService() {
  return require("./bank.reconciliationDifferences.service");
}
```
...
```js id="b08bidx"
// backend/src/index.js
const bankPaymentReturnsRoutes = require("./routes/bank.paymentReturns");
const bankReconciliationDifferenceProfilesRoutes = require("./routes/bank.reconciliationDifferenceProfiles");
...
```js id="b08bmigidx"
// backend/src/migrations/index.js
const m035_bank_returns_and_recon_differences = require("./m035_bank_returns_and_recon_differences");

module.exports = [
  // ...
  m035_bank_returns_and_recon_differences,
];
```
...
- `backend/src/migrations/m036_bank_governance_approvals_sod.js`
...
## 1) Migration — `backend/src/migrations/m036_bank_governance_approvals_sod.js`

```js
// backend/src/migrations/m036_bank_governance_approvals_sod.js

module.exports = {
  id: "m036_bank_governance_approvals_sod",
...
const { evaluateApprovalNeed } = require("./bank.governance.service");
...
const express = require("express");
const svc = require("../services/bank.approvalPolicies.service");
const {
  validatePolicyIdParam,
  validateCreatePolicyBody,
  validateUpdatePolicyBody,
} = require("./bank.approvalPolicies.validators");
...
const express = require("express");
const svc = require("../services/bank.approvals.service");
const {
  validateApprovalRequestIdParam,
  validateListApprovalRequestsQuery,
  validateSubmitApprovalRequestBody,
  validateDecisionBody,
} = require("./bank.approvalRequests.validators");
...
function getExecutionResolver() {
  const bankPaymentBatches = require("../services/bank.paymentBatches.service");
  const reconRules = require("../services/bank.reconciliationRules.service");
  const postTemplates = require("../services/bank.reconciliationPostingTemplates.service");
  const diffProfiles = require("../services/bank.reconciliationDifferenceProfiles.service");
  const paymentReturns = require("../services/bank.paymentReturns.service");
  const reconExceptions = require("../services/bank.reconciliationExceptions.service");
...
const { evaluateApprovalNeed } = require("./bank.governance.service");
const approvalsSvc = require("./bank.approvals.service");
...
```js
// backend/src/index.js
const bankApprovalPoliciesRoutes = require("./routes/bank.approvalPolicies");
const bankApprovalRequestsRoutes = require("./routes/bank.approvalRequests");
...
```js
// backend/src/migrations/index.js
const m036_bank_governance_approvals_sod = require("./m036_bank_governance_approvals_sod");

module.exports = [
  // ...
  m036_bank_governance_approvals_sod,
];
```
...
- `backend/src/migrations/m031_payroll_beneficiary_snapshots.js`
...
## 1) Migration — `backend/src/migrations/m031_payroll_beneficiary_snapshots.js`
...
module.exports = {
  id: "m031_payroll_beneficiary_snapshots",
...
const express = require("express");
const svc = require("../services/payroll.beneficiaries.service");
const {
  validateEmployeeIdParam,
  validateBeneficiaryAccountIdParam,
  validateCreateBeneficiaryAccountBody,
  validateUpdateBeneficiaryAccountBody,
  validateSetPrimaryBody,
} = require("./payroll.beneficiaries.validators");
...
const payrollBeneficiariesSvc = require("./payroll.beneficiaries.service");
...
```js
// backend/src/index.js
const payrollBeneficiariesRoutes = require("./routes/payroll.beneficiaries");
...
```js
// backend/src/migrations/index.js
const m031_payroll_beneficiary_snapshots = require("./m031_payroll_beneficiary_snapshots");

module.exports = [
  // ...
  m031_payroll_beneficiary_snapshots,
];
```
...
- `backend/src/migrations/m032_payroll_close_controls.js`
...
## 1) Migration — `backend/src/migrations/m032_payroll_close_controls.js`
...
module.exports = {
  id: "m032_payroll_close_controls",
...
const express = require("express");
const svc = require("../services/payroll.close.service");
const {
  validateCloseIdParam,
  validatePrepareCloseBody,
  validateRequestCloseBody,
  validateApproveCloseBody,
  validateReopenBody,
} = require("./payroll.close.validators");
...
const payrollCloseSvc = require("./payroll.close.service");
...
```js
// backend/src/index.js
const payrollCloseRoutes = require("./routes/payroll.close");
...
```js
// backend/src/migrations/index.js
const m032_payroll_close_controls = require("./m032_payroll_close_controls");

module.exports = [
  // ...
  m032_payroll_close_controls,
];
```
...
- `backend/src/migrations/m033_payroll_provider_adapters.js`
...
## 1) Migration — `backend/src/migrations/m033_payroll_provider_adapters.js`

```js
// backend/src/migrations/m033_payroll_provider_adapters.js

module.exports = {
  id: "m033_payroll_provider_adapters",
...
const GenericCsvAdapter = require("./payroll.providers.adapters/genericCsv.adapter");
const GenericJsonAdapter = require("./payroll.providers.adapters/genericJson.adapter");
...
const ADAPTERS = {
  ...
  // future examples:
  // ADP: require("./payroll.providers.adapters/adp.adapter"),
  // SAP_PAYROLL: require("./payroll.providers.adapters/sapPayroll.adapter"),
};
...
module.exports = BasePayrollProviderAdapter;
```
...
module.exports = GenericJsonAdapter;
```
...
module.exports = GenericCsvAdapter;
```
...
const {
  getPayrollProviderAdapter,
  listSupportedPayrollProviders,
} = require("./payroll.providers.registry");

const payrollCloseSvc = require("./payroll.close.service");
const payrollRunsSvc = require("./payroll.runs.service");
const payrollLiabilitiesSvc = require("./payroll.liabilities.service");
// Optional later:
// const payrollPostingSvc = require("./payroll.posting.service");
...
const express = require("express");
const svc = require("../services/payroll.providers.service");
const {
  validateConnectionIdParam,
  validateImportJobIdParam,
  validateCreateConnectionBody,
  ...
  validateApplyImportBody,
  validateCreateEmployeeProviderRefBody,
} = require("./payroll.providers.validators");
...
```js
// backend/src/index.js
const payrollProvidersRoutes = require("./routes/payroll.providers");
...
```js
// backend/src/migrations/index.js
const m033_payroll_provider_adapters = require("./m033_payroll_provider_adapters");

module.exports = [
  // ...
  m033_payroll_provider_adapters,
];
```
...
- `backend/src/migrations/m034_sensitive_data_security.js`
...
## 1) Migration — `backend/src/migrations/m034_sensitive_data_security.js`
...
module.exports = {
  id: "m034_sensitive_data_security",
...
const {
  ...
  serializeEnvelope,
  parseEnvelopeText,
} = require("../utils/cryptoEnvelope");
const { redactObject, redactRawPayloadText } = require("../utils/redaction");
```
...
```js
// backend/src/index.js
const { assertEncryptionConfigured } = require("./utils/cryptoEnvelope");
...
```js
// backend/src/migrations/index.js
const m034_sensitive_data_security = require("./m034_sensitive_data_security");

module.exports = [
  // ...
  m034_sensitive_data_security,
];
```
...
- `backend/src/migrations/m035_job_engine.js`
...
## 1) Migration — `backend/src/migrations/m035_job_engine.js`
...
const bankFeedPullHandler = require("./bankFeedPull.handler");
const bankWebhookProcessHandler = require("./bankWebhookProcess.handler");
const paymentSyncRetryHandler = require("./paymentSyncRetry.handler");
const payrollImportApplyHandler = require("./payrollImportApply.handler");
...
const bankProvidersSvc = require("../bank.providers.service");
...
const bankWebhooksSvc = require("../bank.webhooks.service");
...
const paymentSyncSvc = require("../bank.reconciliation.service");
...
const payrollProvidersSvc = require("../payroll.providers.service");
...
const crypto = require("crypto");
const { getJobHandler } = require("./jobHandlers");
const { redactObject } = require("../utils/redaction");
...
const express = require("express");
const jobsSvc = require("../services/jobs.service");
...
const os = require("os");
const jobsSvc = require("../src/services/jobs.service");
const { createDbPool } = require("../src/db"); // adapt if needed
...
```js id="hqb38x"
// backend/src/index.js
const jobsAdminRoutes = require("./routes/jobs.admin");
...
```js id="vx7d4b"
// backend/src/migrations/index.js
const m035_job_engine = require("./m035_job_engine");
...
- `backend/src/migrations/m036_performance_indexes.js`
...
- `backend/src/migrations/m037_approval_policy_engine.js`
...
- `backend/src/migrations/m038_exception_workbench.js`
...
- `backend/src/migrations/m039_data_retention_archival.js`
